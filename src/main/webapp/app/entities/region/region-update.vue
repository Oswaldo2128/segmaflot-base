  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="pruebaApp.region.home.createOrEditLabel"
          data-cy="RegionCreateUpdateHeading"
          v-text="$t('pruebaApp.region.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pruebaApp.region.regionName')" for="region-regionName">Region Name</label>
            <input
              type="text"
              class="form-control"
              name="regionName"
